...
<span className='text-white font-semibold'>Our roadmap is focused on: </span>
  ...
  If we execute — <span className='  bg-gradient-to-r from-[#15FFDF] to-[#00C965] 
      ...
      <div className="container mx-auto px-6 lg:px-8 text-center space-y-6">
        ...
        {/* — Social / app links */}
        <div className="mt-8 flex justify-center space-x-6 text-2xl text-gray-400">
          <a href="#" className="hover:text-[#00FF9F]"><FiX /></a>
          <a href="#" className="hover:text-[#00FF9F]"><FaYoutube /></a>
          <a href="#" className="hover:text-[#00FF9F]"><FaDiscord /></a>
        </div>
      </div>
    </section>
                </div>
