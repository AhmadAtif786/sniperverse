...
const features = [
  { title: 'New Token Drops', icon: '/1feat.png',active: true },
  { title: 'Smart \n Filters   ',   icon: '/stash_filter.png',         active: false },
  { title: 'Telegram \n Alert',  icon: '/tel.png',         active: false },
  { title: 'Buy \n Button',      icon: '/works/auto-buy.png',             active: false },
  { title: 'Finicon \n XP',      icon: '/fin.png',             active: false },
  { title: 'Rewards \n  ',         icon: '/fluent_reward-20-filled.png',                active: false },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 items-stretch">
          {features.map((f) => (
            <div
              key={f.title}
              className="h-full flex flex-col rounded-xl p-[1px] bg-gradient-to-r from-[#15FFDF4D] to-[#00C9654D]"
            >
              <div
                className={
              ...
              >
              <div className='bg-[#00000026] rounded-full h-15 w-15' 
              style={{
    display: 'flex',
    justifyContent: 'center',
    alignItems: 'center',
              }}>  <Image src={f.icon} alt={f.title} width={33} height={29} className='w-7 h-7'  /></div>
                <h4 className="text-lg font-semibold mb-1 whitespace-pre-line mt-4">{f.title}</h4>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {before} 
                  {''}
                  <span className="mx-1 text-[#00ffad] font-semibold">{highlight}</span>
                  {''}
